...
import mii.co.id.serversideascent.model.Authority;
...
public class AuthorityController extends BasicCrudController<Authority, Long>{
    
    @Autowired
    public AuthorityController(BasicCrudService service) {
        super(service);
    }
